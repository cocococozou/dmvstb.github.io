...
```{r, warning=FALSE, message=FALSE, echo=FALSE}
plot_vess<-ggplotly(ggplot(df, aes(x = dmage, y = vessel, colour=dmage)) +
    geom_histogram(stat = "identity", width = .6) +
...
```{r, warning=FALSE, message=FALSE, echo=FALSE}
plot_nerve<-ggplotly(ggplot(df, aes(x = dmage, y = nerve, colour=dmage)) +
    geom_histogram(stat = "identity", width = .6) +
...
plot_kidney<-ggplotly(ggplot(df, aes(x = dmage, y = kidney, colour=dmage)) +
    geom_histogram(stat = "identity", width = .6) +
...
```{r, warning=FALSE, message=FALSE, echo=FALSE}
plot_depress<-ggplotly(ggplot(df, aes(x = dmage, y =depression, colour=dmage)) +
    geom_histogram(stat = "identity", width = .6) +
